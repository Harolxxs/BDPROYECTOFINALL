...
public void create(Venta_1 venta)
    ...
    try {
        ...
        if (findVenta_1(venta.getPlacac()) != null) {

            throw new PreexistingEntityException(
                "La venta del auto con placa "
                + venta.getPlacac()
                + " ya existe.",
                ex
            );
  ...
  public void destroy(String placa)
    ...
    public Venta_1 findVenta_1(String placa) {
    ...
    try {
        ...
        return em.find(Venta_1.class, placa);
   ...
   public boolean autoYaVendido(String placa) {
    ...
    try {
        ...
        Query q = em.createNamedQuery(
            "Venta_1.findByPlacac"
        );

        q.setParameter("placac", placa);
